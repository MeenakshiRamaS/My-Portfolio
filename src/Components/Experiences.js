...
const Experiences = () => {
        ...
        const arr = [
            {
                orgName: "Technica",
                orgDescription: "Technica is the world’s largest hackathon for underrepresented genders. Every fall, hackers from around the world join us—both in person and virtually—to bring their visions to life!",
                orgRole: "Spons 2025 Co-Director",
                orgRoleDetails: "I joined Technica as a Sponsorship Organizer in 2024 and now serve as one of the Sponsorship Co-Directors for Technica 2025. If you're interested in sponsoring our hackathon, I’d love to connect with you! Feel free to check out our website below!",
                imagesArr: [
                    {
            ...
            },
            {
                ...
                orgDescription: "The Quality Enhancement Systems and Teams (QUEST) Honors Program is a multidisciplinary, hands-on program at the University of Maryland that brings together students from business, engineering, and computer science to solve real-world problems through team-based projects and experiential learning.",
                orgRole: "Cohort 44 + QCorp",
                orgRoleDetails: "I am a member of Cohort 44 and had incredible the opportunity to build my project management and design thinking skills this past semester. Click here to take a look at my team's project! I am also a member of the social organization QUEST Corporate. As part of QCorp I work to build strong relations with our corporate partners and plan events such as our Annual Fall Networking Event. If you are interested in attending as a sponsor, please feel free to reach out!",
                imagesArr: [
                    {
            ...
            {
                orgName: "Hack4Impact",
                orgDescription: "Hack4Impact is a national, a student-run 501(c)(3) organization dedicated to building software for social impact and this is the UMD Chapter. Hack4Impact partners with nonprofits every semester to build free software solutions to help NPOs better serve their communities. Feel free to check out our website below!",
                orgRole: "Sourcing + Bootcamp",
                orgRoleDetails: "I joined Hack4Impact-UMD as a Sourcing Team Member in Fall 2024 and have continued my journey in the organization. I graduated from the Bootcamp in Spring 2025 and am eager to work in a project team as an engineer or PM this fall!",
                imagesArr: [
                    {
            ...
            },
            {
                ...
                orgDescription: "AWS has a series of student-led Cloud Clubs across the world and this is the UMD Chapter. We host beginner friendly workshops and provide our members resources for AWS certifications!",
                orgRole: "Prev President/Cloud Captain",
                orgRoleDetails: "I joined this organization as a member in Fall 2023 and became the President for the 2024-2025 academic year. One of our key features was representing our club in Arlington at the Annual AWS Community Day this past fall!",
                imagesArr: [
                    {
                        imgName: "aws_pres1",
                        imgUrl: awsImg1,
    ...
    return (
        <section className="font-quicksand scroll-mt-20" id="experiences" style = {{ backgroundColor: '#110C19'}}>
            <h2 className = "text-[#9388a2] text-3xl font-quicksand text-center py-4 mt-20">Experiences</h2>
            ...
            {arr.map((org, orgIndx) => (
                ...
                >
                    ...
                    <h3 className="text-[#341948] text-xl font-semibold">{org.orgName}</h3>
            ...
            {openModal && currOrg && (<Modal closeModal={handleCloseModal} org={currOrg}/>)}
        </section>
    )
}
